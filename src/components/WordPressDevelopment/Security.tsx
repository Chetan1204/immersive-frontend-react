    ...
    <section className="security-wrapper">
      <div className="security-container">
        <h2 className="security-title">
          Building Resilience with Optimized <br /> Word Press Security Practices
        </h2>
        <p className="security-subtitle">
          As a custom word press application development services provider, we
          understand the importance of safeguarding your data and maintaining
          the integrity of your word press application. This is why we prioritize
