...
import "./Desktop.css";
import "./Mobile.css";
import UXDPractices from "./UXDPractices";
import BrandAndAwards from "./BrandAndAwards";
import DesignerWorkShop from "./DesignerWorkShop";
          ...
          <div className="col-lg-10">
            <div className="service-app-banner">
              <div className="text-white text-center banner-content" id="bannerContent">
                <h1 className="font-bann"> Mobile App User Interface & Experience Design</h1>
                <p className="pera">   With our defined approach and step by step process, we deliver beyond what's expected. Our team doesn't <br/> limit itself to delivering a product. We craft brilliance together and deliver experiences that are ever-evolving. </p>
