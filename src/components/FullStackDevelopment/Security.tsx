    ...
    <section className="security-wrapper">
      <div className="security-container">
        <h2 className="security-title">
          Building Resilience with Optimized <br />Full Stack Security Practices
        </h2>
        <p className="security-subtitle">
          As a custom software development services provider, we
          understand the importance of safeguarding your data and maintaining
          the integrity of your software development processes. This is why we prioritize
