    ...
    <section className="security-wrapper">
      <div className="security-container">
        <h2 className="security-title">
          Building Resilience with Optimized <br /> QA & Software Testing Security Practices
        </h2>
        <p className="security-subtitle">
          As a custom QA & Software Testing services provider, we
          understand the importance of safeguarding your data and maintaining
          the integrity of your QA & Software Testing processes. This is why we prioritize
