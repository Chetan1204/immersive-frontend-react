...
const DevelopmentProcess: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const isMobile = window.innerWidth < 769; // disable sticky on mobile (<=768px)
          ...
          >
            <Col lg={6}>
              <div className="industry-best left-box" ref={leftBoxRef}>
                ...
                <p style={{ fontSize: 21 }}>
                  As a top-rated blockchain software development company, we have
                  almost a decade of industry experience, having delivered multiple
                  custom blockchain solutions. Our team understands just the right
                  development process that aligns well with your project
                  requirements.
                </p>
              </div>
            </Col>
